...
for(const name of ['雷科','鈦昇','創新服務']){
  const links=marketTopicLinks([],name);
  assert(links.some(x=>x.id==='glass_substrate'),`${name} should receive glass substrate market overlay`);
}
