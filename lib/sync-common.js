...
const HEADERS = {
  'User-Agent': 'Mozilla/5.0 (StockZone/2.6.2.13; Taiwan market snapshot)',
...
module.exports = {
  ...
  ensureMarketHistorySchema, upsertPriceRows, upsertPriceAndHistoryRows, upsertMarketHistoryRows, refreshMarketActivityFactors, replaceDisposalMarket
};
