...
const TOPIC_SPECS = Object.freeze([
  ...
  {id:'cpo_silicon_photonics',name:'CPO／矽光子',scope:'technology-fine',parentName:'科技',members:['cpo','npo','silicon_photonics','optical_engine'],aliases:['CPO','NPO','矽光子','Silicon Photonics','光引擎'],companySeeds:['鴻勁'],companySymbols:['7769'],referenceSeeds:['台積電','訊芯-KY','日月光投控','聯鈞','眾達-KY'],referenceSymbols:['2330','6451','3711','3450','4977'],referenceSourceUrl:'https://www.cna.com.tw/news/afe/202606260255.aspx'},
  ...
  {id:'leo_satellite',name:'低軌衛星',scope:'technology-fine',parentName:'科技',members:[],aliases:['LEO','Starlink','衛星通訊'],companySeeds:['華通','昇達科','金寶','台燿','中美晶','攸泰科技','事欣科'],referenceSeeds:['台揚','兆赫','稜研科技'],referenceSymbols:['2314','2485','7812'],sourceUrl:'https://money.udn.com/money/story/12040/9732923',referenceSourceUrl:'https://news.ustv.com.tw/content/%E4%BD%8E%E8%BB%8C%E8%A1%9B%E6%98%9F%E6%A6%82%E5%BF%B5%E8%82%A1'},
...
module.exports=Object.freeze({
  version:'1.3.0',TOPIC_SPECS,TOPIC_EVIDENCE_RULES,listMarketDefinitions,marketDefinitionById,marketDefinitionForSource,
