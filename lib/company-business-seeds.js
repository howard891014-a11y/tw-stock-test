...
const GROUPS = Object.freeze({
  ...
  copos: uniq(['志聖','萬潤']),
  foplp: uniq(['群創','晶彩科','由田','辛耘','弘塑']),
  glass_substrate: uniq(['群創','台玻','東捷']),
  handler: uniq(['鴻勁','致茂']),
  ...
  resistor: uniq(['國巨','大毅','華新科','光頡']),
  inductor: uniq(['國巨','華新科','禾伸堂']),
  capacitor: uniq(['國巨','華新科','禾伸堂','信昌電']),
  crystal_oscillator: uniq(['晶技','希華','加高','泰藝']),
  ...
  // v2.6.2.33-B — TPEx Industry Value Chain F000 / J000 / I000 exact product-chain expansion.
  // These labels are official product-chain memberships rather than generic industry fallbacks.
  display_module: uniq(['技嘉','憶聲','全台','豐藝','亞帝歐','鑫聯大投控','光聯','青雲','久正']),
  ...
  battery_module: uniq(['全漢','禾伸堂','順達','加百裕','西勝','鑫聯大投控','新盛力','新普','台達電','致茂','美律','敦吉','台表科','系統電','廣錠','聚和','長園科','博大','天宇']),
  ...
  printer_scanner_projector: uniq(['全友','金寶','鴻海','佳世達','宏碁','大同','虹光','燦坤','百容','亞光','永崴投控','致伸','天瀚','鼎翰','鑫聯大投控','中光電投控','亞泰','科誠','協益','中光電','東友','順發','全譜','海柏特','能率網通']),
  hinge_mechanism: uniq(['信錦','新日興','鑫禾','富世達','錦明','兆利','鑫聯大投控']),
  filter_oscillator: uniq(['國巨','敦吉','希華','華新科','禾伸堂','晶技','鈞寶','台嘉碩','鑫科','安碁','佳邦','聯寶','能率網通','加高','泰藝']),
  wired_communication_equipment: uniq(['東訊','隴華','佳世達','大同','宏正','圓展','豪勉','訊達電腦','華電網','互動','宇智']),
