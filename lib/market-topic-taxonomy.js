...
function marketTopicLinks(rawLinks=[],companyName='',companyCode=''){
  const byId=new Map();
...
module.exports=Object.freeze({
  version:'1.0.2',TOPIC_SPECS,listMarketDefinitions,marketDefinitionById,marketDefinitionForSource,marketTopicLinks,auditSummary,normalizeName
});
