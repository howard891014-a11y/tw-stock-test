...
const TAGS = Object.freeze([
  ...
  tag("semiconductor_other_business", "半導體其他業務", "semiconductor", { voteEligible: true, resolution: "fallback" }),
  tag("electronic_components_other", "電子零組件其他", "tech", { voteEligible: true, resolution: "fallback" }),
  tag("computer_peripheral_other", "電腦週邊其他", "computing", { voteEligible: true, resolution: "fallback" }),
  tag("optoelectronics_other", "光電其他", "optical", { voteEligible: true, resolution: "fallback" }),
  tag("communication_other", "通信網路其他", "networking", { voteEligible: true, resolution: "fallback" }),
  tag("information_service_other", "資訊服務其他", "software", { voteEligible: true, resolution: "fallback" }),
  tag("electronic_distribution_other", "電子通路其他", "electronics_services", { voteEligible: true, resolution: "fallback" }),
  tag("other_electronics_business", "其他電子業務", "electronics_services", { voteEligible: true, resolution: "fallback" }),
  tag("digital_cloud_other", "數位雲端其他", "software", { voteEligible: true, resolution: "fallback" }),
  ...
  tag("telecom", "電信", null, { kind: "sector", resolution: "coarse", voteEligible: true }),
  ...
  tag("conglomerate", "綜合", null, { kind: "sector", resolution: "coarse", voteEligible: true }),
