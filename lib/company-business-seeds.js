...
const GROUPS = Object.freeze({
  ...
  emc_protection_component: uniq(['穩得','聚鼎','富致']),
  rfid_tag: uniq(['永道-KY']),
  digital_remittance: uniq(['東聯互動']),
  renewable_energy_equipment: uniq(['安葆']),
  pcb_tooling: uniq(['尖點']),
  ferrite_magnetic_component: uniq(['越峰','松上','聯寶']),
  image_sensor_module: uniq(['菱光']),
  surface_treatment: uniq(['匯鑽科','中砂','新鋼','世豐','運錩','建通','位速','柏騰','光頡','健策']),
  digital_media_streaming: uniq(['愛爾達-創']),
  motor_driver_ic: uniq(['點晶','類比科','廣閎科']),
  pneumatic_component: uniq(['亞德客-KY','氣立']),
  water_treatment_engineering: uniq(['天意能創','山林水']),
  bmc: uniq(['信驊','新唐','系微']),
  server_chassis: uniq(['晟銘電','迎廣']),
  bt_substrate: uniq(['欣興','臻鼎-KY']),
  abf_substrate: uniq(['臻鼎-KY']),
  hdi: uniq(['臻鼎-KY','華通','燿華']),
  ...
  hdd_component: uniq(['銘異','百達-KY','銘鈺']),
  ...
  ups: uniq(['碩天','台達電','飛宏']),
  high_speed_connector: uniq(['嘉澤','貿聯-KY','優群','佳必琪','嘉基','正淩']),
  hbm: uniq(['日月光投控','力成','矽格']),
  oled: uniq(['錸寶','友達','群創','智晶','華凌']),
  ...
  bios_firmware: uniq(['華碩','鑫聯大投控','系微','研通','華豫寧']),
  ...
  display_controller_ic: uniq(['聯發科','聯詠','凌通','聚積','普誠','瑞鼎','奕力-KY']),
  optical_storage_controller_ic: uniq(['凌陽','聯發科']),
  image_sensor_ic: uniq(['凌陽','聯詠','矽創','原相','映智','晶相光']),
  ...
  ic_module: uniq(['福懋','台達電','創見','立萬利','凌航','鈺寶-創','全訊','同欣電','福懋科','宇瞻','威剛','泰谷','尚立','利機','廣穎電通','安國','品安','商丞','群聯','駿吉-KY','凌陽','天擎']),
  ...
  chipset: uniq(['威盛','豐藝','鑫聯大投控','旺玖','聯傑']),
  ...
  fiber_component: uniq(['矽瑪']),
  optical_lens: uniq([
    '鴻海','佳能','敦吉','百容','大立光','亞光','華晶科','玉晶光','揚明光','佳凌','今國光','中揚光','澤米',
    '先進光','聯一光電','新鉅科','鑫聯大投控','久禾光','保勝光學','伯特光','淳安','輝創','虎山'
  ]),
