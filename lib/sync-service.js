const {
  ...
  upsertMarketHistoryRows, refreshMarketActivityFactors, replaceDisposalMarket
} = require('./sync-common');
...
module.exports = {
  runPriceSync, runTwseDisposalSync, runTpexDisposalSync, runMarketHistoryBackfill,
  _test: {
    twseOpenApiRows, twseRwdRows, tpexPriceRows, tpexHistoricalRows, dateFromTwseRwd, pctChange, assertMarketHistoryCoverage,
