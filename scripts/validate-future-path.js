...
for(const h of [3,5,10])calibration.stats.transition[h]={n:100,medianDx:0,medianDy:0,q20Dx:-.4,q80Dx:.4,q20Dy:-1.2,q80Dy:1.2,directions:{
  '右上':{n:46,medianDx:.12*h,medianDy:.30*h,q20Dx:.06*h,q80Dx:.18*h,q20Dy:.15*h,q80Dy:.45*h},
  '右下':{n:38,medianDx:.10*h,medianDy:-.28*h,q20Dx:.04*h,q80Dx:.16*h,q20Dy:-.42*h,q80Dy:-.14*h},
  '盤整':{n:16,medianDx:0,medianDy:0,q20Dx:-.08,q80Dx:.08,q20Dy:-.25,q80Dy:.25}
}};
const g={x:.4,y:-.2,phaseState:'transition',phaseConfidence:65,confirmation:62,dx3:.42,dy3:.25};
...
console.log('Future Path Top-2 validation PASS — raw-coordinate A/B paths with separate smooth forecast corridors');
