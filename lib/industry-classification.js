...
// Technology codes use fine-business fallback buckets; non-tech codes use coarse votable sectors.
...
const INDUSTRIES = Object.freeze({
  ...
  '24': { name:'半導體業', technology:true, fallbackTag:'semiconductor_other_business' },
  '25': { name:'電腦及週邊設備業', technology:true, fallbackTag:'computer_peripheral_other' },
  '26': { name:'光電業', technology:true, fallbackTag:'optoelectronics_other' },
  '27': { name:'通信網路業', technology:true, fallbackTag:'communication_other' },
  '28': { name:'電子零組件業', technology:true, fallbackTag:'electronic_components_other' },
  '29': { name:'電子通路業', technology:true, fallbackTag:'electronic_distribution_other' },
  '30': { name:'資訊服務業', technology:true, fallbackTag:'information_service_other' },
  '31': { name:'其他電子業', technology:true, fallbackTag:'other_electronics_business' },
  '32': { name:'文化創意業', broadTag:'cultural_creative' },
  '33': { name:'農業科技業', broadTag:'agri_tech' },
  '35': { name:'綠能環保', broadTag:'green_energy' },
  '36': { name:'數位雲端', technology:true, fallbackTag:'digital_cloud_other' },
