...
const TAGS = Object.freeze([
  ...
  tag("filter_oscillator", "濾波器／振盪器", "passive", { voteEligible: true, aliases: ["濾波器", "振盪器", "Filter", "Oscillator"] }),
  ...
  // v2.6.2.33-B — TPEx F000 computer/peripheral subcategories, split out so native-tech
  // companies no longer need the generic minimum business label when an official product chain exists.
  tag("display_module", "顯示器模組", "display", { voteEligible: true, aliases: ["Display Module", "顯示模組"] }),
  tag("motherboard", "主機板", "computing", { voteEligible: true, aliases: ["Motherboard"] }),
  tag("computer_chassis", "電腦機殼", "computing", { voteEligible: true, aliases: ["PC機殼", "Computer Chassis"] }),
  tag("battery_module", "電池模組", "power_electronics", { voteEligible: true, aliases: ["Battery Pack", "電池包"] }),
  tag("io_interface_card", "輸出入模組／介面卡", "computing", { voteEligible: true, aliases: ["I/O模組", "介面卡"] }),
  tag("notebook_pc", "筆記型電腦", "computing", { voteEligible: true, aliases: ["Notebook", "Laptop"] }),
  tag("desktop_pc", "桌上型電腦", "computing", { voteEligible: true, aliases: ["Desktop PC", "桌機"] }),
  ...
  tag("printer_scanner_projector", "印表機／掃描器／投影機", "computing", { voteEligible: true, aliases: ["印表機", "掃描器", "投影機", "事務機"] }),
  tag("hinge_mechanism", "機構樞紐", "computing", { voteEligible: true, aliases: ["Hinge", "轉軸"] }),
  tag("wired_communication_equipment", "有線通訊設備", "networking", { voteEligible: true, aliases: ["有線通訊", "VoIP設備", "網路電話"] }),
